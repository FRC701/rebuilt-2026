...
public class Agitator extends SubsystemBase {
  ...
  public Agitator() {
    ...
    if (Utils.isSimulation()) {
      ...
      m_flywheelSim =
          new FlywheelSim(
              LinearSystemId.createFlywheelSystem(DCMotor.getKrakenX44Foc(1), Constants.AgitatorConstants.kSimAgitatorMOI, Constants.AgitatorConstants.kSimAgitatorGearRatio),
